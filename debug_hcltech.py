"""
Debug HCLTECH SHORT Signal at 1:07 PM
"""
...
def main():
    print("=" * 80)
    print("HCLTECH SHORT SIGNAL ANALYSIS - 1:07 PM")
    print("=" * 80)
    print()
    ...
    print(f"YOUR TRADE:")
    print(f"  SHORT Entry: ₹{entry_price} at 1:07 PM")
    print(f"  Exit (Loss): ₹{exit_price} at 1:15 PM")
    print(f"  Loss: ₹{loss:.2f} ({loss_pct:.2f}%) ❌")
    print(f"  Hold time: 8 minutes")
    print()
    
    # Fetch data
    ticker = yf.Ticker("HCLTECH.NS")
    ...
    print(f"HCLTECH today: {len(df_today)} candles")
    ...
    print("=" * 80)
    print("5-MINUTE DATA (12:55 PM - 1:30 PM) - TODAY's DATA ONLY")
    print("=" * 80)
    print()
    
    try:
        analysis_df = df_today.between_time('12:55', '13:30')
    except:
    ...
    for idx, row in analysis_df.iterrows():
        ...
        highlight = ""
        if "13:05" <= time_str <= "13:10":
            highlight = " <-- ENTRY"
        elif "13:15" <= time_str <= "13:20":
            highlight = " <-- EXIT"
    ...
    print()
    print("=" * 80)
    print("ANALYSIS AT ENTRY TIME (~1:07 PM)")
    print("=" * 80)
    
    try:
        entry_candles = df_today.between_time('13:05', '13:10')
        if len(entry_candles) > 0:
            entry_candle = entry_candles.iloc[0]
            
            print()
            print(f"AT SIGNAL TIME (~13:05):")
    ...
    print()
    print("=" * 80)
    print("YOUR 7 TRADES TODAY - SUMMARY")
    print("=" * 80)
    print()
    ...
    print(f"| 7  | HCLTECH      | SHORT     | 13:07  | -{loss_pct:.2f}%  | ??? |")
