"""
Debug HINDUNILVR SHORT Signal at 11:40 AM
"""
...
def main():
    print("=" * 80)
    print("HINDUNILVR SHORT SIGNAL ANALYSIS - 11:40 AM")
    print("=" * 80)
    print()
    ...
    print(f"YOUR TRADE:")
    print(f"  SHORT Entry: ₹{entry_price} at 11:40")
    print(f"  Exit (Loss): ₹{exit_price} at 11:47")
    ...
    print(f"HINDUNILVR today: {len(df_today)} candles")
    ...
    print("=" * 80)
    print("5-MINUTE DATA (11:15 AM - 12:00 PM) - TODAY's DATA ONLY")
    print("=" * 80)
    print()
    
    try:
        analysis_df = df_today.between_time('11:15', '12:00')
    except:
    ...
    for idx, row in analysis_df.iterrows():
        ...
        highlight = ""
        if "11:40" <= time_str <= "11:45":
            highlight = " <-- ENTRY"
        elif "11:45" <= time_str <= "11:50":
            highlight = " <-- EXIT"
    ...
    print()
    print("=" * 80)
    print("ANALYSIS AT ENTRY TIME (~11:40)")
    print("=" * 80)
    
    try:
        entry_candles = df_today.between_time('11:35', '11:45')
        if len(entry_candles) > 0:
            entry_candle = entry_candles.iloc[-1]  # Get 11:40 candle
            
            print()
            print(f"AT SIGNAL TIME (~11:40):")
    ...
    print()
    print("=" * 80)
    print("YOUR 5 TRADES TODAY - SUMMARY")
    print("=" * 80)
    print()
    print("| #  | Stock        | Direction | Time  | Result  | Issue                    |")
    print("|----|--------------|-----------|-------|---------|--------------------------|")
    print("| 1  | POLICYBZR    | SHORT     | 9:27  | -1.92%  | NaN indicators           |")
    print("| 2  | UNIONBANK    | LONG      | 10:08 | -0.38%  | NaN indicators           |")
    print("| 3  | KOTAKBANK    | SHORT     | 10:47 | +0.14%  | ADX < 20, ST NaN         |")
    print("| 4  | TORNTPHARM   | SHORT     | 11:25 | -0.42%  | ST was BULLISH           |")
    print(f"| 5  | HINDUNILVR   | SHORT     | 11:40 | -{loss_pct:.2f}%  | Analyzing...             |")
    print()
    print(f"NET RESULT: Approximately -2.69% total loss")
