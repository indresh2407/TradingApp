"""
Debug HAPPSTMNDS SHORT Signal at 2:58 PM
"""
...
def main():
    print("=" * 80)
    print("HAPPSTMNDS SHORT SIGNAL ANALYSIS - 2:58 PM")
    print("=" * 80)
    print()
    ...
    print(f"YOUR TRADE:")
    print(f"  SHORT Entry: ₹{entry_price} at 2:58 PM")
    print(f"  Exit (Loss): ₹{exit_price}")
    print(f"  Loss: ₹{loss:.2f} ({loss_pct:.2f}%) ❌")
    print()
    
    # Fetch data
    ticker = yf.Ticker("HAPPSTMNDS.NS")
    ...
    print(f"HAPPSTMNDS today: {len(df_today)} candles")
    ...
    print("=" * 80)
    print("5-MINUTE DATA (2:45 PM - 3:30 PM) - TODAY's DATA ONLY")
    print("=" * 80)
    print()
    
    try:
        analysis_df = df_today.between_time('14:45', '15:30')
    except:
    ...
    print()
    print("=" * 80)
    print("ANALYSIS AT ENTRY TIME (~2:58 PM)")
    print("=" * 80)
    
    try:
        entry_candles = df_today.between_time('14:55', '15:00')
        if len(entry_candles) > 0:
            entry_candle = entry_candles.iloc[0]
            
            print()
            print(f"AT SIGNAL TIME (~14:55):")
    ...
    print()
    print("=" * 80)
    print("YOUR 9 TRADES TODAY - SUMMARY")
    print("=" * 80)
    print()
    ...
    print("| 8  | ICICIBANK    | SHORT     | 13:42  | -0.20%  | ❌ ST Bull |")
    print(f"| 9  | HAPPSTMNDS   | SHORT     | 14:58  | -{loss_pct:.2f}%  | ??? |")
